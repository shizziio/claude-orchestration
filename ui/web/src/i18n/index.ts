...
import enDevflow from "./locales/en/devflow.json";
...
import viDevflow from "./locales/vi/devflow.json";
...
import zhDevflow from "./locales/zh/devflow.json";
...
const ns = [
  ...
  "cli-credentials", "packages", "tenants", "devflow",
] as const;
